...
enum {
	...
	ERROR_EXTERN_LABEL_NOT_DECLARED,
	...
	ERROR_IMMEDIATE_INVALID,
	ERROR_DIRECT_REGISTER_INVALID,
	ERROR_INDIRECT_REGISTER_INVALID,
	ERROR_IMMEDIATE_OVERFLOW,
	...
	ERROR_OBJECT_FILE_ACCESS = 		-5,
	ERROR_EXTERN_FILE_ACCESS = 		-4,
	ERROR_ENTRY_FILE_ACCESS = 		-3,
	...
	OPCODE_BIT_SHIFT =			11,
	SRC_ADDRESSING_BIT_SHIFT =		7,
	DST_ADDRESSING_BIT_SHIFT =		3,

	FIFTEEN_BIT_3_BITS_MSB_MASK = 		28672,
	TWELVE_BIT_3_BITS_MSB_MASK = 		3584,
	NINE_BIT_3_BITS_MSB_MASK =		448,	
	SIX_BIT_3_BITS_MSB_MASK =		56,	
	THREE_BIT_3_BITS_MSB_MASK = 		7,	
	
	IMMEDIATE_OVERFLOW = 			4096
};
